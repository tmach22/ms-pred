"""
Phase 4 — Multi-Head Sinkhorn-FiLM Evaluation Script
====================================================
...
def test(args: argparse.Namespace) -> None:
    ...
    print(f"\n{'='*50}")
    print(f"  PHASE 4 SINKHORN PROBE METRICS")
    print(f"{'='*50}")
...
def _cli() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Phase 4: Multi-Head Sinkhorn-FiLM Testing Script")
